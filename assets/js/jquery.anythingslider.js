...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.setCurrentPage = function(page, move) {
			...
			if($(base.$items[base.currentPage]).find('.slide').attr('id') != null){
				window.location.hash =  $(base.$items[base.currentPage]).find('.slide').attr('id');
				window.scrollTo(0,0);
			}
	...
	$.anythingSlider.defaults = {
		...
		easing              : "swing",   //*applied easeOutBack* Anything other than "linear" or "swing" requires the easing plugin or jQuery UI

		buildArrows         : true,      // If true, builds the forwards and backwards buttons
		buildNavigation     : true,      //*applied false* If true, builds a list of anchor links to link to each panel
		buildStartStop      : true,      //*applied false* If true, builds the start/stop button
